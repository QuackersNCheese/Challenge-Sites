...
console.log(findNeedle(haystack_1) == 'found the needle at position 3' ? "Pass" : "Fail: haystack_1");
console.log(findNeedle(haystack_2) == 'found the needle at position 5' ? "Pass" : "Fail: haystack_2");
console.log(findNeedle(haystack_3) == 'found the needle at position 30' ? "Pass" : "Fail: haystack_3");
console.log(findNeedle(haystack_4) == 'found the needle at position 5' ? "Pass" : "Fail: haystack_4");